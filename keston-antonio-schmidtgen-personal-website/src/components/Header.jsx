  ...
  <div className="relative px-8 pt-10 mx-auto max-w-7xl">
    ...
    <div className="flex flex-col items-center justify-between w-full md:flex-row">
      <div className="">
        ...
        <p className="text-lg text-gray-400 my-7">The story about my amazing journey starts right here. <br className="hidden xl:block" />This is the story of my life.<br /></p>
      </div>
